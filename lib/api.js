...
//        this.sendXMLRequest("/roap/api/auth", {auth: {type: "AuthKeyReq"}}).then(resolve, reject);
        this.sendXMLRequest("/hdcp/api/auth", {auth: {type: "AuthKeyReq"}}).then(resolve, reject);
...
//        this.sendXMLRequest("/roap/api/auth", {auth: {type: "AuthReq", value: this.pairingKey}}).then(
        this.sendXMLRequest("/hdcp/api/auth", {auth: {type: "AuthReq", value: this.pairingKey}}).then(
            data => {
...
//        this.sendXMLRequest("/roap/api/command", {command: parameters}).then(
        this.sendXMLRequest("/hdcp/api/dtv_wifirc", {command: parameters}).then(
            data => {
